    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="flex flex-col">
        ...
        >
          ...
          <h1 className="text-[14vw] md:text-[160px] font-display font-black leading-[0.8] tracking-tight uppercase text-fg-main mb-12">
            DESIGN <br />
            <span className="text-accent">LIMITS</span>
          </h1>
          
          <div className="flex flex-col md:flex-row justify-between items-end gap-12 border-t border-border-theme pt-12">
            <h2 className="text-2xl font-light tracking-tight text-gray-400 max-w-sm">
              Crafting high-fidelity digital experiences for forward-thinking brands.
            </h2>
            <p className="w-full md:w-1/3 text-[11px] leading-relaxed uppercase tracking-[0.2em] text-gray-600">
          ...
          <div className="mt-16 flex flex-wrap gap-4 md:gap-6">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              href="#portfolio"
              className="flex-1 md:flex-none text-center bg-accent text-black px-10 py-6 text-[11px] font-black uppercase tracking-[0.4em] flex items-center justify-center gap-4 group transition-colors"
            >
              View Portfolio
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              href="#contact"
              className="flex-1 md:flex-none text-center border border-border-theme text-fg-main px-10 py-6 text-[11px] font-black uppercase tracking-[0.4em] transition-all"
            >
              Contact Me
            </motion.a>
          </div>
        ...
        <motion.div
          ...
          className="relative aspect-[21/9] rounded-none overflow-hidden bg-bg-page border border-border-theme"
        >
          <img 
